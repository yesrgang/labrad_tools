...
class CWControl(QtGui.QGroupBox):
    ...
    def populateGUI(self):
        ...
        self.frequency_box = SuperSpinBox(self.frequency_range, 5)
    ...
    def connectSignals(self):
        ...
        self.frequency_box.editingFinished.connect(self.onNewFrequency)
    ...
    def receive_values(self, c, signal):
        ...
        if name == self.name:
            ...
            if not 0:
                print 'f', frequency
                self.frequency_box.display(frequency/self.frequency_units)
...
if __name__ == '__main__':
    ...
    from sixdds_config import SixDDSConfig
    conf = SixDDSConfig()
