...
class SuperSpinBox(QtGui.QLineEdit):
    """ it really is! """
    def __init__(self, display_range, units):# num_decimals, display_factor=1):
        ...
        self.num_decimals = 1 # number of digits after decimal point to be displayed
        self.setText('0.0')
    ...
    def format_number(self, value):
        ...
        factor = min(zip(*self.units)[0], key=lambda x: abs(x-np.floor(np.log10(value))+1))
