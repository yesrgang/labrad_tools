...
#                        print dataset, directory, index, key
        ...
        if (drawCurves == False):                        
            self.solutionsWindow = SolutionsWindow(self, self.context, self.solutionsDictionary, self.errorsDictionary)
...
class SolutionsWindow(QtGui.QWidget):
    ...
    def __init__(self, parent, context, solutionsDictionary, errorsDictionary):
        QtGui.QWidget.__init__(self)
        self.parent = parent
        self.context = context
        self.solutionsDictionary = solutionsDictionary
        self.errorsDictionary = errorsDictionary
        self.labels = []
        self.textBoxes = []
#        self.refitButtons = []
        self.acceptButtons = []
