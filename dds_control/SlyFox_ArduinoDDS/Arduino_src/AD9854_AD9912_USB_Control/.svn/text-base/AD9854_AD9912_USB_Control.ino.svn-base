...
void DDS1_Init(void) {
  ...
  SPI.transfer(0x00); //Initialization bits
  delayMicroseconds(10);
  SPI.transfer(0x10); //Turn on PLL
  delayMicroseconds(10);
  SPI.transfer(0x40); //PLL on
  delayMicroseconds(10);
  digitalWrite(pinCS_1,HIGH);
  
//  SPI.transfer(0x00); //N-divider byte address
//  delayMicroseconds(10);
//  SPI.transfer(0x20); //N-divider byte address
//  delayMicroseconds(10);
//  SPI.transfer(0x16); //(22+2)*4 = 96
//  delayMicroseconds(10);
  
//  SPI.transfer(0x00); //Doubler and VCO autorange
//  delayMicroseconds(10);
//  SPI.transfer(0x22); //Doubler and VCO autorange
//  delayMicroseconds(10);
//  SPI.transfer(0x0C); //auto-range VCO, PLL doubler, default charge pump
//  delayMicroseconds(10);
  digitalWrite(pinCS_1,LOW);
  SPI.transfer(0x00); //N-divider byte address
  delayMicroseconds(10);
  SPI.transfer(0x20); //N-divider byte address
  delayMicroseconds(10);
  SPI.transfer(0x02); //(2+2)*2 = 8...so 800 MHz
  delayMicroseconds(10);
  digitalWrite(pinCS_1,HIGH);
  ...
  SPI.transfer(0x22); //Doubler and VCO autorange
  delayMicroseconds(10);
  SPI.transfer(0x00); //auto-range VCO off, PLL doubler off, default charge pump
  delayMicroseconds(10);
...
//  //set frequency
  digitalWrite(pinCS_1,LOW);
  SPI.transfer(0x01); //write 1 byte
  SPI.transfer(0xAB);
  SPI.transfer(0x20);
  digitalWrite(pinCS_1,HIGH);
