...
name = VISA Bus
version = 1.13
description = Gives access to remote devices via pyvisa.
instancename = %LABRADNODE% VISA Bus
...
class VisaBusServer(LabradServer):
    name = '%LABRADNODE% VISA Bus'
    ...
    def address(self, c, addr=None):
        """Get or set the instrument address for this context.
    ...
    def query(self, c, data):
        """Make a query, a write followed by a read.
