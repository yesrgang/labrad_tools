class SequencerConfig(object):
    def __init__(self):
        ...
        self.channels = {
                        ...
                        'D00': {'name': 'TTLD00', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        'D01': {'name': 'TTLD01', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        'D02': {'name': 'TTLD02', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        'D03': {'name': 'TTLD03', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        'D04': {'name': 'TTLD04', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        'D05': {'name': 'TTLD05', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        'D06': {'name': 'TTLD06', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        'D07': {'name': 'TTLD07', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        'D08': {'name': 'TTLD08', 'mode': 'auto', 'manual state': 0, 'invert': 0},
