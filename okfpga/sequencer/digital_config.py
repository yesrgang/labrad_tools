class SequencerConfig(object):
	...
	self.update_id = 698024
        ...
        self.channels = {
                        ...
                        'A05': {'name': 'Abs. Shutter', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        'A06': {'name': '2D Mot Shutter', 'mode': 'auto', 'manual state': 0, 'invert': 1},
                        'A07': {'name': 'Zeeman Shutter', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        ...
                        'A11': {'name': 'Side Camera Trigger', 'mode': 'auto', 'manual state': 0, 'invert': 0},
                        ...
                        'D09': {'name': 'Broadband trigger', 'mode': 'auto', 'manual state': 0, 'invert': 0},
