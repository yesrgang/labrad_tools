...
class BoardABCD(YeSrDigitalBoard):
    ...
    channels = [
        ...
        DigitalChannel(loc=['B', 2], name='Beta FM Switch', mode='auto', manual_output=False, invert=False),
        ...
        DigitalChannel(loc=['C', 2], name='LR AOM Sweep', mode='auto', manual_output=False, invert=True),
        DigitalChannel(loc=['C', 3], name='LR Demod Sweep', mode='auto', manual_output=False, invert=False),
        DigitalChannel(loc=['C', 4], name='LR/HR [hi/lo]', mode='auto', manual_output=False, invert=False),
        DigitalChannel(loc=['C', 5], name='HR AOM Sweep', mode='auto', manual_output=False, invert=False),
        DigitalChannel(loc=['C', 6], name='HR Demod Sweep', mode='auto', manual_output=False, invert=False),
        ...
        DigitalChannel(loc=['C', 9], name='RM Table Shutters', mode='manual', manual_output=True, invert=False),
        DigitalChannel(loc=['C', 10], name='RM Horizontal Shutter', mode='auto', manual_output=False, invert=False),
        DigitalChannel(loc=['C', 11], name='Transp. AOM', mode='auto', manual_output=False, invert=False),
        DigitalChannel(loc=['C', 12], name='Troubleshoot', mode='auto', manual_output=False, invert=False),
        DigitalChannel(loc=['C', 13], name='Alpha FM Switch', mode='auto', manual_output=False, invert=False),
        DigitalChannel(loc=['C', 14], name='Transp. Shutter', mode='auto', manual_output=False, invert=False),
        ...
        DigitalChannel(loc=['D', 11], name='StepperMotor', mode='manual', manual_output=False, invert=False),
