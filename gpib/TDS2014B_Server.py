...
class TDS2014BWrapper(GPIBDeviceWrapper):
    @inlineCallbacks
...
class TDS2014BServer(GPIBManagedServer):
    #Provides basic control for Tektronix 2014B Oscilloscope
    name = 'TDS2014B'
    deviceName = 'TEKTRONIX TDS 2014B'
    deviceWrapper = TDS2014BWrapper
